...
# Levenstein Distance and Error Rate Whisper Transcription
...
paragraph1_whisper = process_file("paragraph1_whisper.txt")
paragraph2_whisper = process_file("paragraph2_whisper.txt")
paragraph3_whisper = process_file("paragraph3_whisper.txt")
...
leven_1 = levenshtein_dynamic(paragraph1_golden, paragraph1_whisper)
leven_2 = levenshtein_dynamic(paragraph2_golden, paragraph2_whisper)
leven_3 = levenshtein_dynamic(paragraph3_golden, paragraph3_whisper)
...
print(paragraph1_whisper)
print(paragraph2_whisper)
print(paragraph3_whisper)
